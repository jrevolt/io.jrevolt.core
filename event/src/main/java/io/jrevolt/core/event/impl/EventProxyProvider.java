package io.jrevolt.core.event.impl;

import io.jrevolt.core.event.Event;
import static io.jrevolt.core.util.Assert.*;

import io.jrevolt.core.util.Assert;
import io.jrevolt.core.util.ReflectHelper;
...
public class EventProxyProvider {
	...
	static private final boolean ENABLE_EVENT_DISPATCHER_PROXY = true;
